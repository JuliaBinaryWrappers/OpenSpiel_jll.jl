...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import OpenSpiel_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("bd10a763-4654-5023-a028-c4918c6cd33e"))
platforms = [Pkg.Artifacts.unpack_platform(e, "OpenSpiel", artifacts_toml) for e in artifacts["OpenSpiel"]]
...
if best_platform === nothing
    @debug("Unable to load OpenSpiel; unsupported platform $(triplet(platform_key_abi()))")
else
